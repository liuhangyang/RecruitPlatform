...
$(function () {
    ...
    var table = $("#recruitnews").DataTable({
         "ajax":{
             "url":'http://127.0.0.1:8080/recruit/get_recruit_msg/',
             "withCredentials":true,
         },
        "columns": [
            {"data": "recruit_title"},
            {"data": "person_name"},
            {"data": "recruit_releasetime"},
    ...
    $('#commitbtn').click(function () {
        ...
        $.post("http://127.0.0.1:8080/recruit/commit_recruit_news/", {
